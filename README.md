Данный проект представляет собой движок для создания **браузерных многопользовательских игр**. Он выделился в самостоятельный проект в процессе разработки игры [http://kaerton.ru](http://kaerton.ru).
